...
public:
	...
	CBQBParameterSet_Compressor(CBQBInterface &i) : m_IF(i) {
...
public:
	...
	CBQBParameterSet_Position(CBQBInterface &i) : m_IF(i), m_oCompressor(i) {
...
public:
	...
	CBQBParameterSet_Volumetric(CBQBInterface &i) : m_IF(i), m_oCompressor(i) {
...
public:
	...
	CBQBParameterSet_PosAndVol(CBQBInterface &i) : m_IF(i), m_oPosition(i), m_oVolumetric(i) {
	}
