...
void AddElementData()
{
	...
	// 1st Period
	AddElement("H",    1,   1.00798,  37.0, 110.0,  1.7568);
	AddElement("D",    1,   2.01410,  37.0, 110.0);
	...
	AddElement("Sc",  21,  44.95591, 144.0,   0.0);
	AddElement("Ti",  22,  47.8671,  136.0, 187.0);
	AddElement("V",   23,  50.94151, 125.0,   0.0);
	AddElement("Cr",  24,  51.99616, 127.0,   0.0);
	AddElement("Mn",  25,  54.93804, 139.0,   0.0);
	AddElement("Fe",  26,  55.8452,  125.0,   0.0);
	AddElement("Co",  27,  58.93319, 126.0,   0.0);
	...
	AddElement("Y",   39,  88.90584, 162.0,   0.0);
	AddElement("Zr",  40,  91.2242,  148.0,   0.0);
	AddElement("Nb",  41,  92.90637, 137.0,   0.0);
	AddElement("Mo",  42,  95.951,   145.0,   0.0);
	AddElement("Tc",  43,  98.00,    131.0,   0.0);
	AddElement("Ru",  44, 101.072,   126.0,   0.0);
	AddElement("Rh",  45, 102.90550, 135.0,   0.0);
	...
	AddElement("La",  57, 138.90548, 169.0,   0.0);

	AddElement("Ce",  58, 140.1161,  204.0,   0.0);
	AddElement("Pr",  59, 140.90766, 203.0,   0.0);
	AddElement("Nd",  60, 144.2423,  201.0,   0.0);
	AddElement("Pm",  61, 145.00,    199.0,   0.0);
	AddElement("Sm",  62, 150.362,   198.0,   0.0);
	AddElement("Eu",  63, 151.9641,  198.0,   0.0);
	AddElement("Gd",  64, 157.253,   196.0,   0.0);
	AddElement("Tb",  65, 158.92535, 194.0,   0.0);
	AddElement("Dy",  66, 162.5001,  192.0,   0.0);
	AddElement("Ho",  67, 164.93033, 192.0,   0.0);
	AddElement("Er",  68, 167.2593,  189.0,   0.0);
	AddElement("Tm",  69, 168.93422, 190.0,   0.0);
	AddElement("Yb",  70, 173.0545,  187.0,   0.0);
	AddElement("Lu",  71, 174.96681, 187.0,   0.0);

	AddElement("Hf",  72, 178.492,   150.0,   0.0);
	AddElement("Ta",  73, 180.94788, 138.0,   0.0);
	AddElement("W",   74, 183.841,   146.0,   0.0);
	AddElement("Re",  75, 186.2071,  159.0,   0.0);
	AddElement("Os",  76, 190.233,   128.0,   0.0);
	AddElement("Ir",  77, 192.2173,  137.0,   0.0);
	AddElement("Pt",  78, 195.0849,  138.0,   0.0);
	AddElement("Au",  79, 196.96657, 144.0,   0.0);
	AddElement("Hg",  80, 200.5923,  149.0,   0.0);

	AddElement("Tl",  81, 204.384,   148.0,   0.0);
	AddElement("Pb",  82, 207.21,    146.0,   0.0);
	AddElement("Bi",  83, 208.98040, 146.0,   0.0);
	...
	AddElement("Ra",  88, 226.00, 221.0,   0.0);

	AddElement("Ac",  89, 227.00, 215.0,   0.0);

	AddElement("Th",  90, 232.03774, 206.0,   0.0);
	AddElement("Pa",  91, 231.03588, 200.0,   0.0);
	AddElement("U",   92, 238.02891, 196.0,   0.0);
	AddElement("Np",  93, 237.00, 190.0,   0.0);
