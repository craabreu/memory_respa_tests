...
public:
	...
	CBQBIndex(CBQBInterface &i) : m_IF(i) {
	}
...
public:
	...
	CBQBTrajectoryFrameColumn(CBQBInterface &i) : m_iType(255), m_IF(i) {
	}
...
public:
	...
	CBQBTrajectoryFrame(CBQBInterface &i) : m_iAtomCount(0), m_pCellMatrix(NULL), m_IF(i) {
	}
