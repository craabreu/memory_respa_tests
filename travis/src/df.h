...
//			abort();
	...
	void AddToBinInt_Fast(int i, double d)
	{
//		if (i >= m_iResolution)
//			abort();
	...
	void AddToBin_Multi_Int_Fast(int i, int n, double f)
	{
		m_pBin[n] += f;
		m_pMultiBin[i][n] += f;
	}
